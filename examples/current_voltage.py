...
def get_current_voltage_example() -> tuple[list[tuple], list[tuple]]:
    """
    ...
    Returns:
        List of statements and list of possible hypothesis
    """
    ...
    return current_model, current_model_statements
