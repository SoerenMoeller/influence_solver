...
"""
Changed:
- Changed named tuple fields (removed data, added 'quality', 'begin_other', 'end_other'
- Added method for turning intervals
- Changed overlap method boundaries
- Changed contains_points method boundaries
- Changed __eq__ and added new fields
- Changed _get_fields
- Changed __repr__
- Changed copy
- Changed __cmp__
